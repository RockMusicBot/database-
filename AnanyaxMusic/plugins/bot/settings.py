...
async def send_repo(_, message: Message):
    await message.reply_video(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("🎵 Music + Management Bot Repo", url="https://github.com/NoxxOP/AnanyaMusic")],
                [InlineKeyboardButton("🎧 Only Music Bot Repo", url="https://github.com/NoxxOP/AnanyaxMusic")]
            ]
        ),
